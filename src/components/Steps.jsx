...
const Steps = () => {
  return (
    ...
    my-32'>
        {/* so basically we have already created the array in assets.js file where the data of steps we have added already */}
      <h1 className='text-3xl sm:text-4xl font-semibold mb-2'>
        ...
        <div className='space-y-4 w-full max-w-3xl text-sm'>
            {/* for using java we have to use curly braces and we are importin the data from assets folder  */}
