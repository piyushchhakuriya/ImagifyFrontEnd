    ...
    className='min-h-[80vh] text-center pt-14 mb-10'>
      ...
      <h1 className='text-center text-3xl font-medium mb-6 sm:mb-10'>Choose the plan</h1>
       ...
       <div className='flex flex-wrap justify-center gap-6 text-left'>
        ...
        <div className='bg-white drop-shadow-sm border-0 rounded-lg py-12 px-8 text-gray-600 hover:scale-105 transition-all duration-500'
         key={index}>
          ...
          <p className='mt-3 mb-1 font-semibold'>
            ...
            <p className='mt-6'>
              <span className='text-3xl font-bold'>${items.price}</span> / {items.credits} credits</p>
